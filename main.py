...
args.add_argument("--attack", type=str, default="linfpgd",
                  choices=["linfpgd", "l2pgd", "l2bim", "linfbim", "l2cwa", "linfcwa"])
...
args.add_argument("--add_step", type=int, default=5)
args.add_argument("--minus_step", type=int, default=0)
...
if __name__ == "__main__":
    ...
    if args.attack == "linfpgd":
        attack = LinfPGD(steps=args.attack_step, rel_stepsize=args.attack_step_size)
    elif args.attack == "l2pgd":
        attack = L2PGD(steps=args.attack_step, rel_stepsize=args.attack_step_size)
    elif args.attack == "l2bim":
        attack = L2BasicIterativeAttack(
            steps=args.attack_step, rel_stepsize=args.attack_step_size)
    elif args.attack == "linfbim":
